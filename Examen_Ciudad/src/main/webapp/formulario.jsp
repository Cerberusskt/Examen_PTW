...
<body>
<video src="imagenes/formulario.mp4" autoplay loop muted></video>
<main>
    ...
    <form action="respuesta_f.jsp" method="post">
    <table border="0">
				<tr>
				<td>ID:</td>
				...
				<tr>
				<td>NOMBRE:</td>
				<td><input type="text" name="nombre" class=field required/>*</td>
				</tr>
				<tr>
				<td>APELLIDO:</td>
				<td><input type="text" name="apellido" class=field  required/>*</td>
				</tr>	
				
				<tr>
				<td>CORREO ELECTRONICO</td>
				<td><input type="email" name="txtemail" class=field required/>*</td>
				</tr>

				<tr>
				<td>FECHA:</td>
				<td><input type="datetime-local" name="fecha" class=field  required/>*</td>
				</tr>
														
				<tr>
				<td><br><input type="submit" class="btn btn-green" value="Enviar Datos"><td/><br>
